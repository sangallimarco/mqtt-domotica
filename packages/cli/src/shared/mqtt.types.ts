export enum Topic {
  ...
  // RPI MQTT
  RPI_ZERO_LIGHT_STATUS = 'rpis/garden/17/status',
  RPI_ZERO_LIGHT_SWITCH = 'rpis/garden/17/command',
  RPI_ZERO_PUMP_STATUS = 'rpis/garden/27/status',
  RPI_ZERO_PUMP_SWITCH = 'rpis/garden/27/command',
